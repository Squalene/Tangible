...
final static int LOST_POINTS = 5;
 ...
 * 
 * @param previousAngle: Previous Angle.
 * @param addedAngle: The angle to add.
 * @param maxAngle: Maximum angle.
 * @return: The new angle clamped
 */
float clampAngle(float previousAngle, float addedAngle, float maxAngle) {

  float newAngle=previousAngle+addedAngle;
