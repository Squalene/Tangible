...
void setup() {
  ...
  //gameSurface = createGraphics(GAME_SURFACE_WIDTH,GAME_SURFACE_HEIGHT, P3D);
  //bottomPane = createGraphics(BOTTOM_PANE_SURFACE_WIDTH, BOTTOM_PANE_SURFACE_HEIGHT, P2D);
  //topView = createGraphics(TOP_VIEW_SURFACE_WIDTH, TOP_VIEW_SURFACE_HEIGHT, P2D);
  //scoreboard = createGraphics(SCOREBOARD_SURFACE_WIDTH, SCOREBOARD_SURFACE_HEIGHT, P2D);
  //barChart = createGraphics(BAR_CHART_SURFACE_WIDTH, BAR_CHART_SURFACE_HEIGHT, P2D);
  //oldScores = new int[BAR_CHART_NUMBER_RECTANGLES_WIDTH];
